        ...
        <div class="row">
            <div class="col-8">
                <div class="flex flex-center relative-position full-height">
                    <img
                        src="illustrations/undraw_sign_up_n6im.svg"
                        style="width: 600px"
                    />
                </div>
            </div>
            <div class="col-4">
                ...
                >
                    ...
                    >
                        ...
                        <q-card-actions>
                            <q-btn flat dense color="primary" to="/login">
                                已有账号? 去登录
                            </q-btn>
                        </q-card-actions>
                    </q-form>
...
const signupInfo = ref<StringIndexedObject>({
    username: '',
    password: '',
    passwordConfirm: '',
});
...
const formInputs = ref<InputProps[]>([
    ...
    },
    {
        ...
        isPassword: true,
        rules: [
            (val: string) => (!!val && val.length > 0) || '请再次输入密码',
            (val: string) =>
                val === signupInfo.value.password || '两次输入的密码不一致',
        ],
    },
]);
</script>
